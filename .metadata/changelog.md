####################################
# GATES OF THE BOSPHORUS CHANGELOG #
####################################
...
Fixes:
- mgrbfm_tunis.002 will no longer promote Ahmad to ruler only to immediately kill him
- eqfm_pirates.008 will now trigger correctly; this was preventing the global piracy journal from completing
- Fixed a case where recruiting the Pirate leader could fail if he was not created from the player country's scope
- The Adriatic Expedition peril bar is now red instead of green
...
- Bosnia & Libya are now Exempt from Military Service at game start
...
- Removed ruler popularity from Bavarocracy Instability progress value
- Political Instability now caps out at 200, up from 100
- Dismissing the Bavarians and Releasing Nikitas will also reduce instability
- Expanded localization and script value entries for the Dynastic Rivalry journal
- Rescripted the Senusiyya journal, events, and effects
- Rescripted the script values for the Senussi journal
- Adjusted starting Senussi support to 20 from 50
- Senussi completion buttons now require completion of the Centralization/Modernization journals
...
- Greek King options have been disabled for the AI
- Bavarocracy completion triggers now correctly account for players taking the Tyranny route
...
- Fixed reversed comparison in the Xenocracy journal
- turkfm_sweep_desert_button now cares about which specific desert states you control
- Fixed turkfm_libya.101 spamming from monthly pulse
...
--Update 3.1.2--
New Additions:
- Added a topbar element for the Expanded Topbar Framework
...
--Update 3.0.2--
Fixes:
- Reworked poor effect structure in turkfm.005 & turkfm.006
...
• First Chapter of Romanian Flavor:
	-The Regulamentul Organic: Guide the Romanian Principalities through their transition from post-Ottoman state & elect a new Hospodar every 7 years.
